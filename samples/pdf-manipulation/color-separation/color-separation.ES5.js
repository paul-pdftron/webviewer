  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', fullAPI: !0, initialDoc: '../../../samples/files/op-blend-test.pdf' }, document.getElementById('viewer')).then(function(t) {
      ...
      n.on('documentLoaded', function() {
        var e = n.getDocument();
        e.enableColorSeparations(!0),
          e.on('colorSeparationAdded', function(o) {
            var i = document.createElement('input');
            (i.id = o.name),
              (i.type = 'checkbox'),
              (i.checked = o.enabled),
              (i.onchange = function(r) {
                t.openElements(['loadingModal']), e.enableSeparation(o.name, r.target.checked), n.refreshAll(), n.updateView();
              });
            var u = document.createElement('label');
            (u.id = ''.concat(o.name, ' label')), (u.htmlFor = o.name), (u.style.color = 'rgb('.concat(o.rgb.join(','), ')')), (u.innerHTML = o.name);
            var c = document.createElement('br');
            r.appendChild(i), r.appendChild(u), r.appendChild(c);
          });
      }),
        n.on('mouseMove', function(t) {
          ...
          if (null !== o) {
            ...
            if (i)
              for (var u = i.pageIndex + 1, c = i.x, f = i.y, a = n.getColorSeparationsAtPoint(u, c, f), s = 0; s < a.length; ++s)
