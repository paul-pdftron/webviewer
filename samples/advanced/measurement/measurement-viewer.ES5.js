    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || T(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : T(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
    ...
    WebViewer({ path: '../../../lib', initialDoc: '../../../samples/files/houseplan-A.pdf', enableMeasurement: !0 }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t),
        t.setHeaderItems(function(t) {
          t.delete('textToolGroupButton'),
            t.delete('freeHandToolGroupButton'),
            t.delete('shapeToolGroupButton'),
            t.delete('signatureToolButton'),
            t.delete('freeTextToolButton'),
            t.delete('stickyToolButton'),
            t.delete('miscToolGroupButton'),
            t.delete('eraserToolButton');
        }),
