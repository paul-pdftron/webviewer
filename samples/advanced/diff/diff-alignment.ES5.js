  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? M : S('values'), keys: g ? M : S('keys'), entries: F }), d)) for (b in m) b in O || i(O, b, m[b]);
    ...
    !(function(t) {
      ...
      t.DiffAlignment = {
        ...
        retrievePageMatrix: function(t, n) {
          var r = t.docViewer,
            e = r.getCompleteRotation(n + 1),
            o = r.getPageWidth(n),
            i = r.getPageHeight(n),
            u = r.getPageZoom(n),
            c = window.getPageMatrix(u, e, { width: o, height: i }, 0, !0, t.iframeWindow.utils.getCanvasMultiplier());
          return { a: c.m_a, b: c.m_b, c: c.m_c, d: c.m_d, e: c.m_h, f: c.m_v };
        },
        createCanvasForLineAlignment: function(e, i, u, c, f, a, s, l) {
          ...
          p.setTransform(u.a, u.b, u.c, u.d, u.e, u.f), p.translate(c.x, c.y), c.x > f.x || c.y > f.y ? (v *= -1) : v > 0 && (v *= -1), p.rotate(v);
          var g = o(c.x, c.y, f.x, f.y),
            d = o(a.x, a.y, s.x, s.y) / g / l;
          p.scale(d, d), p.rotate(y);
          var m = -n(c.x, c.y, v + y) / d,
            b = -r(c.x, c.y, v + y) / d;
          return p.translate(m, b), p.translate(n(a.x, a.y, v + y) / d, r(a.x, a.y, v + y) / d), p.translate(-c.x * l, -c.y * l), h;
        },
