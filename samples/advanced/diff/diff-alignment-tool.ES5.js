          ...
          o && u(t, c, l, a, s),
            e ||
              ...
              document.getElementById('enable-snap-mode').addEventListener('change', function(n) {
                ...
                t.docViewer.getTool('AnnotationCreateArrow').setSnapMode(r ? t.docViewer.SnapMode.e_DefaultSnapMode : null),
                  c.docViewer.getTool('AnnotationCreateArrow').setSnapMode(r ? c.docViewer.SnapMode.e_DefaultSnapMode : null);
              }));
        },
