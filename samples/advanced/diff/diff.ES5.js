!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var d, y, g = i(n), m = o(g), b = r(c, v, 3), S = u(m.length), x = 0, w = e ? h(n, S) : a ? h(n, 0) : void 0; S > x; x++)
          ...
          b
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(e)) {
                  if (!(e instanceof H || 'ArrayBuffer' == (a = x(e)) || 'SharedArrayBuffer' == a)) return St in e ? It(v, e) : Tt.call(v, e);
                  (i = e), (p = Ot(r, n));
                  var d = e.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              ((v = e(function(t, e, r, o) {
                ...
                return (
                  l(t, v, f),
                  w(e)
                    ? e instanceof H || 'ArrayBuffer' == (i = x(e)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new d(e, Ot(r, n), o)
                        : void 0 !== r
                        ? new d(e, Ot(r, n))
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, d, y, g) {
      ...
      if (
        (I && (S = s(I.call(new t()))) !== Object.prototype && S.next && (f(S, w, !0), r || 'function' == typeof S[l] || u(S, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? M : x('values'), keys: y ? M : x('keys'), entries: F }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, e) {
    ...
    var o = e(1),
      ...
      K = function(t, n) {
        b(t);
        for (var e, r = g((n = w(n))), o = 0, i = r.length; i > o; ) $(t, (e = r[o++]), n[e]);
        return t;
      },
      J = function(t) {
      ...
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== G || !i(W, n) || i(U, n))) {
          var e = T(t, n);
          return !e || !i(W, n) || (i(t, R) && t[R][n]) || (e.enumerable = !0), e;
        }
      },
      tt = function(t) {
        for (var n, e = N(w(t)), r = [], o = 0; e.length > o; ) i(W, (n = e[o++])) || n == R || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
        for (var n, e = t === G, r = N(e ? U : w(t)), o = [], u = 0; r.length > u; ) !i(W, (n = r[u++])) || (e && !i(G, n)) || o.push(W[n]);
        return o;
      };
    z ||
      (a(
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < p.length; ) {
              ...
              var _,
                E = a(m, h ? p : p.slice(x));
              if (null === E || (_ = l(c(m.lastIndex + (h ? 0 : x)), p.length)) === S) x = u(p, x, y);
              else {
    ...
    !(function(t) {
      ...
      var n,
        ...
        T = function(n, e, r, o, i, c, a, f) {
          if (M[e]) {
            var s = w[O].documentContainer.querySelector('.canvas'.concat(n));
            if (s) {
              var l = function(e) {
                var l = w[O].instance.iframeWindow.utils.getCanvasMultiplier(),
                ...
                var x = s.parentNode.querySelector('.canvasOverlay');
                x && x.parentNode.removeChild(x), s.parentNode.appendChild(y);
              };
              I()
                ? w[E].instance.docViewer.getDocument().loadCanvasAsync({
                    pageIndex: n,
                    pageRotation: w[O].instance.docViewer.getRotation(),
                    getZoom: function() {
                      return w[O].instance.docViewer.getZoom();
                    },
        ...
        j = function(n, e, r) {
          var o = w[O].documentContainer.querySelector('.canvas'.concat(n));
          if (o) {
            var i = w[O].instance.iframeWindow.utils.getCanvasMultiplier(),
              u = t.DiffAlignment.retrievePageMatrix(w[O].instance, n),
        ...
        N = function(t, n) {
          ...
          b[n] && r.cancelLoadCanvas(b[n]),
            (b[n] = (function(t, n, e, r) {
              var o = n.querySelector('.canvas'.concat(r));
              if (o && !(r > t.getPageCount() - 1)) {
                ...
                return t.loadCanvasAsync({
                  ...
                  drawComplete: function(t) {
                    (M[r] = t), I() || T(r, r, t, t.width, t.height, _, _, F), (b[r] = null), null == c && (c = e.docViewer.getCompleteRotation(r + 1));
                  },
        ...
        C = function(t) {
          ...
          return r && i
            ...
            : CoreControls.getDefaultBackendType().then(function(n) {
                return t && r ? (i = CoreControls.initOfficeWorkerTransports(n, {})) : (o = CoreControls.initPDFWorkerTransports(n, {}));
              });
        },
        L = function(t, n, e) {
          w[t].instance.loadDocument(n),
            t === O &&
              e &&
              (function(t, n) {
                w[t].instance.CoreControls.createDocument(n, { workerTransportPromise: C(n) }).then(function(n) {
                  w[t] = Object.assign({}, w[t], { newDoc: n });
                });
              })(t, e);
        },
        D = function(t) {
          x.forEach(function(n) {
            var e = w[n.panel].instance;
        ...
        R = function(n, e, r, o, i, u) {
          (a = n),
            ...
            (v = u),
            M[u] &&
              w[O].newDoc.loadCanvasAsync({
                pageIndex: v,
                pageRotation: (4 - c) % 4,
                drawComplete: function(n) {
                  A(!1), (p = n), t.NudgeTool.setPageTransformationState(h, 0, 0, t.DiffUtil.getScaleStateForNudgeToolFromCanvas(1), 0);
                },
              });
        },
        k = function(e) {
              ...
              u.on('documentLoaded', function() {
                ...
                (c.onscroll = function() {
                  ...
                  I() ||
                    ...
                    (e = c.scrollTop),
                    x.forEach(function(n) {
                      var r = w[n.panel].documentContainer;
                ...
                x.push(e),
                (w[e.panel] = { instance: i, viewerElement: o, documentContainer: c }),
                r();
            });
          });
        },
        V = function() {
          var n = w[O].instance.docViewer.getCurrentPage() - 1,
            e = t.NudgeTool.getPageTransformationState(I() ? h : n),
            r = 0;
          for (var o in e) {
            if (e.hasOwnProperty(o)) if (0 !== (r += e[o])) break;
          }
          if ((A(!I() && 0 === r), I())) j(h, v, p);
          else {
            var i = M[n];
            if (!i) return;
          ...
          (c = void 0),
            ...
            t.DiffAlignmentTool.initializeDiffAlignmentToolHandlers(
              ...
              function() {
                ...
                var t = w[O].instance.docViewer.getCurrentPage() - 1;
                D(t + 1), N(O, t);
              }
            );
        };
      (d = [{ panel: E }, { panel: O }, { panel: P }]),
        (y = function() {
          B(''.concat(window.location.href, '../../../samples/files/test_doc_1.pdf'), ''.concat(window.location.href, '../../../samples/files/test_doc_2.pdf')),
            t.NudgeTool.initNudgeTool(w[O].instance, 1, V),
            (document.getElementById('enable-snap-mode').disabled = !w[E].instance.CoreControls.isFullPDFEnabled() && !w[P].instance.CoreControls.isFullPDFEnabled());
        }),
        (g = {}),
        Promise.all(d.map(k)).then(function() {
          ...
          return (
            ...
            n.docViewer.on('beginRendering', function() {
              ...
              (S[t] = n.docViewer.getViewportRegionRect(t)), b[t] && w[O].newDoc.cancelLoadCanvas(b[t]);
            }),
        ...
        (document.getElementById('download-middle-panel-image').onclick = function(t) {
          t.preventDefault(),
            w[O].documentContainer.querySelector('.canvasOverlay').toBlob(function(t) {
