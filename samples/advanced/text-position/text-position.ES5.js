  ...
  function(t, n) {
    ...
    WebViewer({ path: '../../../lib', pdftronServer: 'https://demo.pdftron.com/', initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/legal-contract.pdf' }, r).then(function(t) {
      ...
      var n = t.docViewer,
        ...
        o = function(t, o) {
          var i = n.getDocument();
          i.loadPageText(o, function(n) {
            for (var u, c = 0, f = []; (u = n.indexOf(t, c)) > -1; )
              (c = u + t.length),
                i.getTextPosition(o, u, u + t.length, function(t) {
                  var n = new e.TextHighlightAnnotation();
                  (n.Author = r.getCurrentUser()), (n.PageNumber = o + 1), (n.Quads = t), (n.StrokeColor = new e.Color(0, 255, 255)), f.push(n);
                });
            r.addAnnotations(f), r.selectAnnotations(f);
          });
        },
        i = function(t) {
          var n = r.getAnnotationsList().filter(function(n) {
            return n.PageNumber === t + 1;
          });
        ...
        var t = document.getElementById('text'),
          r = (function(t) {
            ...
            for (n = 0; n < t; n++) {
              ...
              (i.htmlFor = 'page-'.concat(n)), (i.innerHTML = 'Page '.concat(n + 1));
