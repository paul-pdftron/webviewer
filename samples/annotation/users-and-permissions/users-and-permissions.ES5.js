    ...
    WebViewer(
      ...
      n.setCurrentUser('Justin'),
        ...
        (document.getElementById('justin').onchange = function() {
          n.setCurrentUser('Justin'), n.setIsAdminUser(!0), n.setReadOnly(!1), t.setToolMode('AnnotationEdit');
        }),
        (document.getElementById('sally').onchange = function() {
          n.setCurrentUser('Sally'), n.setIsAdminUser(!1), n.setReadOnly(!1), t.setToolMode('AnnotationEdit');
        }),
        (document.getElementById('brian').onchange = function() {
          n.setCurrentUser('Brian'), n.setIsAdminUser(!1), n.setReadOnly(!0), t.setToolMode('AnnotationEdit');
        }),
