    ...
    z ||
      (a(
        (L = function() {
          ...
          return u && Y && q(U, t, { configurable: !0, set: n }), X(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
    ...
    !(function(t) {
      WebViewer(
        ...
        var i = function() {
          n.registerTool(
            ...
            n.setHeaderItems(function(t) {
              ...
              t.get('freeHandToolGroupButton').insertBefore(r), n.setToolMode('AnnotationCreateTriangle');
            });
        };
        (document.getElementById('custom-stamp').onchange = function(t) {
          t.target.checked
            ? (n.registerTool({
              ...
              n.setHeaderItems(function(t) {
                t.get('freeHandToolGroupButton').insertBefore({ type: 'toolButton', toolName: 'CustomStampTool', hidden: ['tablet', 'mobile'] }),
                  t
                    .getHeader('tools')
                    .get('freeHandToolGroupButton')
                    .insertBefore({ type: 'toolButton', toolName: 'CustomStampTool', hidden: ['desktop'] });
              }),
        ...
        var c = function(t, r, e) {
            ...
            if (!r.x || null != f.first) {
              var s = null !== f.first ? f.first : i.getCurrentPage() - 1,
                l = c.getPageInfo(s),
                h = a.windowToPage(r, s),
                p = i.getZoom(),
                v = new o.StampAnnotation();
              v.PageNumber = s + 1;
              var y = 90 * i.getCompleteRotation(s + 1);
              (v.Rotation = y),
