!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Ut, Bt),
        p(Ut, yt, Bt.values),
        v(Ut, { slice: Rt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    j ||
      ...
      (i = function() {
        var t = new e();
        (this.promise = t), (this.resolve = a(B, t, 1)), (this.reject = a(C, t, 1));
      }),
      (b.f = A = function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = F(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      L.prototype[B] || r(14)(L.prototype, B, L.prototype.valueOf),
      h(L, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
      ...
      NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach),
        ...
        document.getElementsByName('theme').forEach(function(n) {
          n.onchange = function(n) {
            'light' === n.target.id && n.target.checked ? t.setTheme('default') : t.setTheme('dark');
          };
        });
    });
  },
