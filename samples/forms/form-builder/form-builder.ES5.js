!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Vt, Dt),
        p(Vt, yt, Dt.values),
        v(Vt, { slice: Ct, set: kt, constructor: function() {}, toString: pt, toLocaleString: Rt }),
        jt(Vt, 'buffer', 'b'),
        jt(Vt, 'byteOffset', 'o'),
        jt(Vt, 'byteLength', 'l'),
        jt(Vt, 'length', 'e'),
    ...
    WebViewer({ path: '../../../lib', initialDoc: '../../full-apis/TestFiles/contract.pdf' }, document.getElementById('viewer')).then(function(t) {
      ...
      (i.convertAnnotToFormField = function() {
        ...
        return (
          t.forEach(function(t, n) {
            ...
            if ('' !== t.getCustomData('type')) {
              var a = new e.WidgetFlags();
              if ((t.getCustomData('flag').readOnly && a.set('ReadOnly', !0), t.getCustomData('flag').multiline && a.set('Multiline', !0), r.push(t), 'TEXT' === t.getCustomData('type')))
                (f = new e.Forms.Field(t.getContents() + Date.now() + n, { type: 'Tx', value: t.getCustomData('value'), flags: a })), (c = new e.TextWidgetAnnotation(f));
              else if ('SIGNATURE' === t.getCustomData('type'))
                (f = new e.Forms.Field(t.getContents() + Date.now() + n, { type: 'Sig', flags: a })),
                  (c = new e.SignatureWidgetAnnotation(f, {
                    appearance: '_DEFAULT',
                    appearances: {
                      _DEFAULT: {
                        Normal: {
                ...
                a.set('Edit', !0);
                var s = new e.Font({ name: 'Helvetica' });
                (f = new e.Forms.Field(t.getContents() + Date.now() + n, { type: 'Btn', value: 'Off', flags: a, font: s })),
                  (c = new e.CheckButtonWidgetAnnotation(f, { appearance: 'Off', appearances: { Off: {}, Yes: {} } }));
              }
              (c.PageNumber = t.getPageNumber()),
                ...
                e.WidgetAnnotation.getCustomStyles(c),
                o.addAnnotation(c),
                u.addField(f),
                i.push(c);
            }
        ...
        (i.addFormFieldAnnot = function(t, i, u, c) {
          ...
          if (!n.x || null != l.first) {
            var h = null !== l.first ? l.first : r.getCurrentPage() - 1,
              p = a.getPageInfo(h),
              v = s.windowToPage(n, h),
              y = new e.FreeTextAnnotation();
            y.PageNumber = h + 1;
            var g = 90 * r.getCompleteRotation(h + 1);
            (y.Rotation = g),
              'CHECK' === t ? ((y.Width = 25 / f), (y.Height = 25 / f)) : 270 === g || 90 === g ? ((y.Width = 50 / f), (y.Height = 250 / f)) : ((y.Width = 250 / f), (y.Height = 50 / f)),
