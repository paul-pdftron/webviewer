!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var d, y, g = i(n), b = o(g), m = e(c, v, 3), x = u(b.length), S = 0, w = r ? p(n, x) : f ? p(n, 0) : void 0; x > S; S++)
          if ((h || S in b) && ((y = m((d = b[S]), S, g)), t))
            if (r) w[S] = y;
            else if (y)
              switch (t) {
                case 3:
    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && f > 2 && (a = s(a, arguments[2], 2)), n = 0, r = y(c.length), o = Ft(this, r); r > n; n++) o[n] = l ? a(c[n], n) : c[n];
          return o;
        },
        kt = function() {
        ...
        Lt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = b(t, e);
            return new (T(r, r[bt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, y((void 0 === n ? e : b(n, e)) - o));
          },
        },
        Rt = function(t, n) {
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                if (w(r)) {
                  ...
                  } else if ((u = y(o) * n) + h > d) throw Y('Wrong length!');
                  c = u / n;
            ...
            : (u(function() {
              ...
              J(b !== Function.prototype ? F(d).concat(F(b)) : F(d), function(t) {
                t in v || p(v, t, d[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
      ...
      if (!p || !v || ('replace' === t && !s) || ('split' === t && !l)) {
        var d = /./[h],
          y = r(u, h, ''[t], function(t, n, r, e, o) {
            return n.exec === f ? (p && !o ? { done: !0, value: d.call(n, r, e) } : { done: !0, value: t.call(r, n, e) }) : { done: !1 };
          }),
          g = y[0],
          b = y[1];
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, h) {
      ...
      if (i(g)) {
        for (p = c(t.length); p > m; m++) if ((y = n ? b(u((v = t[m]))[0], v[1]) : b(t[m])) === a || y === s) return y;
      } else for (d = g.call(t); !(v = d.next()).done; ) if ((y = o(d, b, v.value, n)) === a || y === s) return y;
    }).BREAK = a),
      (n.RETURN = s);
  },
  function(t, n, r) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, d, y, g) {
      ...
      return p(m, t), (w[t] = m), o(o.G + o.W + o.F * (m != b), w), g || d.setStrong(m, t, y), m;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, d, y, g) {
      ...
      if (
        ...
        if (((b = { values: _ ? F : S('values'), keys: y ? F : S('keys'), entries: M }), g)) for (m in b) m in O || i(O, m, b[m]);
      ...
      r(2)(function() {
        ...
        ? function(t, n) {
            for (var r = c(t), a = arguments.length, s = 1, l = i.f, h = u.f; a > s; )
              for (var p, v = f(arguments[s++]), d = l ? o(v).concat(l(v)) : o(v), y = d.length, g = 0; y > g; ) (p = d[g++]), (e && !h.call(v, p)) || (r[p] = v[p]);
            return r;
          }
        : a;
  },
    ...
    t.exports = {
      getConstructor: function(t, n, r, a) {
        var s = t(function(t, e) {
          c(t, s, n, '_i'), (t._t = n), (t._i = o(null)), (t._f = void 0), (t._l = void 0), (t[d] = 0), null != e && f(e, r, t[a], t);
        });
        return (
          i(s.prototype, {
            clear: function() {
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            b = s(h);
          if ((y && (d = e(d, v > 2 ? arguments[2] : void 0, 2)), null == b || (p == Array && c(b)))) for (r = new p((n = f(h.length))); n > g; g++) a(r, g, y ? d(h[g], g) : h[g]);
          else for (l = b.call(h), r = new p(); !(o = l.next()).done; g++) a(r, g, y ? u(l, d, [o.value, g], !0) : o.value);
          return (r.length = g), r;
        },
      }
    );
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = f(b, p ? h : h.slice(S));
              if (null === E || (_ = l(c(b.lastIndex + (p ? 0 : S)), h.length)) === x) S = u(h, S, y);
              else {
  ...
  function(t, n, r) {
    ...
    t.exports = function t(n, r, f, a, s, l, h, p) {
      for (var v, d, y = s, g = 0, b = !!h && u(h, p, 3); g < a; ) {
        if (g in f) {
          if (((v = b ? b(f[g], g, r) : f[g]), (d = !1), o(v) && (d = void 0 !== (d = v[c]) ? !!d : e(v)), d && l > 0)) y = t(n, r, v, i(v.length), y, l - 1) - 1;
          else {
  ...
  function(t, n, r) {
    for (
      ...
      var y,
        ...
        m = u[g],
        x = m && m.prototype;
      if (x && (x[s] || c(x, s, h), x[l] || c(x, l, g), (f[g] = h), b)) for (y in e) x[y] || i(x, y, e[y], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
          ...
          ((s = !h && x && void 0 !== x[a]) && c(b, a)) ||
            ...
            (b[a] =
              p && 'function' != typeof x[a]
                ...
                ? i(Function.call, l)
                : l),
            d && (((b.virtual || (b.virtual = {}))[a] = l), n & t.R && m && !m[a] && u(m, a, l)));
      };
