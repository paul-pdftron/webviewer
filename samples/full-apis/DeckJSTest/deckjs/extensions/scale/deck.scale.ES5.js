...
*/
    !(function(t, n, r, e) {
      var o,
        ...
        f = function(t, n) {
          var r = t.children();
          r.hasClass('loading') || r.hasClass(n.classes.scaleSlideWrapper) || r.wrapAll('<div class="'.concat(n.classes.scaleSlideWrapper, '"/>'));
        },
        a = function() {
          ...
          t.each(i, function(r, i) {
            f(i, n);
            var u = i.innerHeight(),
              c = i.find('.'.concat(n.classes.scaleSlideWrapper)),
              a = e.hasClass(n.classes.scale) ? o / u : 1;
            t.each('Webkit Moz O ms Khtml'.split(' '), function(t, n) {
              1 === a ? c.css(''.concat(n, 'Transform'), '') : c.css(''.concat(n, 'Transform'), 'scale('.concat(a, ')'));
            });
          });
        };
