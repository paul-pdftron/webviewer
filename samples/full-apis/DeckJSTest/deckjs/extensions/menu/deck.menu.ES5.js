!(function(t) {
  ...
  function(t, n, r) {
    ...
    function B(t, n, r, e, o, i) {
      ...
      for (var c = t[A]._b, f = u + t[k], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
        ...
        t.hasClass(n.classes.menu) ||
          ...
          Modernizr.csstransforms &&
            r.each(e, function(t, n) {
              n.data('oldStyle', n.attr('style')), n.css({ position: 'absolute', left: ''.concat((t % 4) * 25, '%'), top: ''.concat(25 * Math.floor(t / 4), '%') });
            }),
