     ...
     * http://modernizr.com/download/?-applicationcache-audio-backgroundsize-borderimage-borderradius-boxshadow-canvas-canvastext-cssanimations-csscolumns-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-flexbox-fontface-generatedcontent-generators-geolocation-hashchange-history-hsla-indexeddb-inlinesvg-input-inputtypes-localstorage-multiplebgs-opacity-postmessage-rgba-sessionstorage-smil-svg-svgclippaths-textshadow-video-webgl-websockets-websqldatabase-webworkers-addtest-domprefixes-hasevent-prefixes-testallprops-testprop-teststyles ! */ !(function(
      ...
      function i(t) {
        ...
        if ((w && (n = n.baseVal), b._config.enableJSClass)) {
          var r = new RegExp('(^|\\s)'.concat(e, 'no-js(\\s|$)'));
          n = n.replace(r, '$1'.concat(e, 'js$2'));
        }
        b._config.enableClasses && ((n += ' '.concat(e).concat(t.join(' '.concat(e)))), w ? (S.className.baseVal = n) : (S.className = n));
      }
      function u(t, n) {
      ...
      function l(n, e) {
        ...
        if ('CSSSupportsRule' in t) {
          for (var i = []; o--; ) i.push('('.concat(s(n[o]), ':').concat(e, ')'));
          return (
            (i = i.join(' or ')),
            f('@supports ('.concat(i, ') { #modernizr { position: absolute; } }'), function(t) {
      ...
      var T = (function(t) {
        ...
        return function(n, r) {
          ...
          return (
            ...
            !(o = (n = 'on'.concat(n)) in r) && e && (r.setAttribute || (r = c('div')), r.setAttribute(n, ''), (o = 'function' == typeof r[n]), r[n] !== t && (r[n] = t), r.removeAttribute(n)),
            o)
          );
        };
      })();
      ...
      var N = function(n) {
        ...
        if (!n) return !1;
        if (((n = n.replace(/^@/, '')), (e = ''.concat(n.replace(/-/g, '_').toUpperCase(), '_RULE')) in i)) return '@'.concat(n);
        for (var u = 0; o > u; u++) {
          var c = O[u];
          if (''.concat(c.toUpperCase(), '_').concat(e) in i) return '@-'.concat(c.toLowerCase(), '-').concat(n);
        }
        return !1;
      };
      m.atRule = N;
      ...
      (b.inputtypes = (function(t) {
        ...
        (function() {
          ...
          for (var t, n, e = ['Width', 'Span', 'Fill', 'Gap', 'Rule', 'RuleColor', 'RuleStyle', 'RuleWidth', 'BreakBefore', 'BreakAfter', 'BreakInside'], r = 0; r < e.length; r++)
            (t = e[r].toLowerCase()), (n = y('column'.concat(e[r]))), ('breakbefore' === t || 'breakafter' === t || 'breakinside' == t) && (n = n || y(e[r])), b.addTest('csscolumns.'.concat(t), n);
        })(),
        ...
        b.addTest('cssgradients', function() {
          ...
          b._config.usePrefixes && (n += ''.concat(t, '-webkit-').concat('gradient(linear,left top,right bottom,from(#9f9),to(white));'));
          var e = c('a').style;
          return (e.cssText = n), ''.concat(e.backgroundImage).indexOf('gradient') > -1;
        }),
        ...
        b.addTest('rgba', function() {
          var t = c('a').style;
          return (t.cssText = 'background-color:rgba(150,255,150,.5)'), ''.concat(t.backgroundColor).indexOf('rgba') > -1;
        }),
